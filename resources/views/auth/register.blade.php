 ...
 <style type="text/css">
    ...
    <body class="bg-info">
		...
		<div class="row">
		    <div class="col-12">
		        <div class=" ">
		            <center><span class="fs-5 text-uppercase fw-bold">Admin Registration Form</span></center>
		        </div>
		    </div>
        ...
        <div class="p-2">
        <form class="form" method="post" action="{{ route('admin.register') }}">@csrf
        <div class="form-group">
             <label>Pin No</label>
               <input type="" name="pin_no" class="form-control form-control-sm pin-no" >
        </div>
        <div class="form-group">
        ...
        <div class="form-group mt-3"> 
            ...
            <label class="text-muted">I Agree <span><a href="#">Terms and Conditions</a></span></label>
        </div>
        <div class="form-group">
           <button type="submit" class="btn btn-warning btn-sm   text-dark fw-bold ">Register</button>
             <a href="{{ url('/admin') }}" class="btn btn-warning btn-sm  fw-bold  text-dark ">Cancel</a>
        </div> 
      	</form> 
       	</div> 
    	</div>
