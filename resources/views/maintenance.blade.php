                        ...
                        <div class="home-wrapper">
                            <div class="mb-5">
                                <a href="index.html" class="d-block auth-logo">
                                    ...
                                    <img src="{{ url('/') }}/public/assets/images/logo-light.png" alt="" height="20" class="auth-logo-light mx-auto">
                                </a>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-3">
                                    <div class="maintenance-img">
                                        <img src="{{url('/')}}/public/assets/images/maintenance.svg" alt="" class="img-fluid mx-auto d-block">
                                    </div>
                                </div>
                            </div>
